SRCS = so_long_main.c utils.c utils_2.c map_all_func.c key_hook.c
SRCBS = main_bonus.c utils_bonus.c utils_2_bonus.c map_all_func_bonus.c key_hook_bonus.c render_bonus.c
NAME = so_long
CC = gcc
